...
class _DeliveryDetailScreenState extends State<DeliveryDetailScreen> {
  ...
  bool _yaLlegoAObra(RemisionResumen? detalle) {
    ...
    return _secuenciaHitos.indexOf(current) >= _secuenciaHitos.indexOf(HitoEntrega.enObra);
  }
  ...
  Future<void> _avanzarHito(HitoEntrega next) async {
    ...
    try {
      final detalle = await OperacionesService.avanzarHito(remisionId, next.backendValue);
                    ...
                    child: ElevatedButton.icon(
                      onPressed: () {
                        Navigator.of(context)
                            .push(MaterialPageRoute(builder: (context) => RouteNavigationScreen(remision: remision)))
            ...
            FutureBuilder<RemisionResumen?>(
              ...
              builder: (context, snapshot) {
                ...
                if (snapshot.hasError) {
                  ...
                  return Text(
                    error is AuthException ? error.message : 'No se pudo cargar el estatus de la remisión',
                ...
                final current = sinIniciar ? null : HitoEntrega.fromBackendValue(detalle.estatus);
                if (!sinIniciar && current == null) {
                  debugPrint('DeliveryDetailScreen: unrecognized estatus="${detalle.estatus}"');
                  ...
                  return Column(
                    children: [
                      if (horarios.isNotEmpty) ...[
                        _HorariosCard(horarios: horarios, cardColor: cardColor, borderColor: borderColor, textColor: textColor, mutedColor: mutedColor),
                      ...
                      _FieldGroup(
                        ...
                        child: Padding(
                          ...
                          child: Text(detalle.estatus, style: TextStyle(fontWeight: FontWeight.w700, color: textColor)),
                        ),
                      ),
                    ],
                  );
                ...
                final currentIndex = sinIniciar ? -1 : _secuenciaHitos.indexOf(current!);
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        onPressed: isFinal || _avanzando
                            ? null
                            : () => _avanzarHito(_secuenciaHitos[currentIndex + 1]),
                        style: ElevatedButton.styleFrom(
                          backgroundColor: _accentYellow,
                          foregroundColor: Colors.black,
                        ...
                        child: _avanzando
                            ...
                            : Text(
                                isFinal ? 'Entrega finalizada' : 'Avanzar a "${_secuenciaHitos[currentIndex + 1].label}"',
                ...
                if (AuthService.rol == 'Operador de Bomba') ...[
                  ...
                  if (remision.remisionId != null) ...[
                    ...
                    _ActionRow(
                      ...
                      onTap: () {
                        Navigator.of(context).push(
                          MaterialPageRoute(builder: (context) => PruebaConcretoScreen(remision: remision)),
                        );
                      },
                    ),
                  ],
        ...
        child: Column(
          ...
          children: [
            for (final (index, entry) in horarios.indexed) ...[
              ...
              Row(
                children: [
                  Expanded(child: Text(entry.$1, style: TextStyle(fontSize: 13.5, color: mutedColor))),
                  Text(_formatHora(entry.$2!), style: TextStyle(fontSize: 13.5, fontWeight: FontWeight.w700, color: textColor)),
                ],
              ),
            ],
          ],
